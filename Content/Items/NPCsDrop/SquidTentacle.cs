...
namespace TremorMod.Content.Items.NPCsDrop;
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        float distance = distToProj.Length();
			...
			// Çàãðóæàåì òåêñòóðó îäèí ðàç, ÷òîáû èçáåæàòü ïîâòîðíîãî çàïðîñà.
			var texture = ModContent.Request<Texture2D>("TremorMod/Content/Items/NPCsDrop/SquidTentacleChain").Value;

        while (distance > 30f && !float.IsNaN(distance))
        {
            distToProj.Normalize();                 // Ïîëó÷àåì åäèíè÷íûé âåêòîð.
            distToProj *= 24f;                      // Ñêîðîñòü öåïè.
            center += distToProj;                   // Îáíîâëÿåì ïîçèöèþ äëÿ îòðèñîâêè.
            distToProj = playerCenter - center;     // Îáíîâëÿåì ðàññòîÿíèå.
            distance = distToProj.Length();
            Color drawColor = lightColor;

            // Êîîðäèíàòû äëÿ îòðèñîâêè.
        ...
        // Âîçâðàùàåì çíà÷åíèå, ÷òîáû óñòðàíèòü îøèáêó.
        return true;
    }
