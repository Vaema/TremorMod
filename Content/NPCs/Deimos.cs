...
namespace TremorMod.Content.NPCs;
	...
	public class Deimos : ModNPC
	{
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Shadowflame, 0f, 0f, 200, NPC.color);
				Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.PurpleCrystalShard, 0f, 0f, 200, NPC.color);
			}
		}
