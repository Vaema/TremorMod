    ...
    public override void OnKill(int timeLeft)
    {
        ...
        if (Projectile.owner == Main.myPlayer)
        {
            ...
            for (int num221 = 0; num221 < num220; num221++)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), // Èñïîëüçóåì ïðàâèëüíûé èñòî÷íèê
                    Projectile.position.X,
                    Projectile.position.Y,
                    value17.X,
                    value17.Y,
                    ModContent.ProjectileType<AdamantiteCloud>(), // Èñïîëüçóåì òèï ñíàðÿäà êàê êëàññ
                    Projectile.damage,
                    1f,
                    Projectile.owner,
                    0f,
