		...
		public override void AI()
		{
			...
			if (Projectile.localAI[0] > 3f)
			{
				for (int num449 = 0; num449 < 4; num449++)
				{
					...
					int num450 = Dust.NewDust(vector34, 1, 1, DustID.HeatRay, 0f, 0f, 0, default(Color), 1f);
					Main.dust[num450].position = vector34;
					Dust expr_13F6C_cp_0 = Main.dust[num450];
					expr_13F6C_cp_0.position.X += Projectile.width / 2;
					Dust expr_13F90_cp_0 = Main.dust[num450];
					expr_13F90_cp_0.position.Y += Projectile.height / 2;
