...
namespace TremorMod.Content.Projectiles;
	...
	public class IgniterPro : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			{
				int num159 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Torch, Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f, 0, default(Color), 0.5f);
